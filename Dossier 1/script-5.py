...
"""
Question 5: 
Définissez le programme complet de ce projet en tenant compte des questions 1 à 4.
"""
...
class Emission(metaclass=abc.ABCMeta):
	...
	def affiche(self):
		print("-------      ------- ")
		print(f"L'émission: {self.is_name}")
		if self.h_debut != -1:
...
class Fiction(Emission):
	...
	def affiche(self):
		...
		if self.is_rediffusion:
			...
			print("C'est la prémière diffusion!!!")
